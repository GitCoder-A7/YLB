...
Для этого вы должны мне их передать в сообщении: order <кол-во переменных> <буквы или слова(словосочетания, но без пробелов, которыми обозначаются переменные переменные вводятся через ОДИН ПРОБЕЛЛ>.
Ввод частей системы уравнений выполняется построчно, но уже с коэфицентами, важно также помнить что свободный член необходимо разместить последним.
После ввода строки система вам предложит нажать на кнопку add чтобы подтвердить ввод. Если же вы ввели уравнение с ошибкой, то вам необходимо просто заново его ввести.
...
Чтобы решить уравнение вам необходимо нажать на клавиатуре кнопку solve. После этого программа проверит что вы предоставили корректные данные и предложит вам или ответ к поставленной или попросит ввести корректное уравнение.
Чтобы удалить предыдущее уравнение в системе необходимо нажать на кнопку delete_prev
Чтобы удалить всю систему уравнений необходимо нажать на кнопку clear_all
Чтобы посмотреть на уже введенную матрицу необходимо написать в чат print
